...
INPUT_FOLDER = './'#/home/aadeshpande2/Project3/models/'
OUTPUT_FOLDER = './'#/home/aadeshpande2/Project3/models/'
MODEL_SAVE_NAME = 'ddqn.pth'
MODEL_LOAD_NAME = 'ddqn.pth'
...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        self.logging_enabled = True#args.logging_enabled or False
        ...
        if args.test_dqn:
            ...
            ###########################
            # YOUR IMPLEMENTATION HERE #
            loaded_state_dicts = self.load_model(args.test_model_file)
